...
public class MenuActivity extends AppCompatActivity {
    ...
    private void refreshData() {
        try {
            ...
            TextView editItemNameTV = (TextView) findViewById(R.id.edititem_name);
            editItemNameTV.setText("");
            TextView editItemPriceTV = (TextView) findViewById(R.id.edititem_price);
            editItemPriceTV.setText("");
    ...
    public void populateGridView(){
        ...
        try{
            for (int i = 0; i < this.items.size(); i++) {
                ...
                menuItemList.add(String.format("%.2f", ((double)this.items.get(i).getPrice())/100));
            }
    ...
    public void addItem(View v) {
        ...
        try {
            ...
            if (e.getMessage().equals("empty String")) {
                displayExceptionMessage("Menu item price cannot be empty!");
            } else {
                e.printStackTrace();
                displayExceptionMessage(e.getMessage());
            }
    ...
    public void updateItem(View v) {
        ...
        try {
            ...
            if (stringFigure.length() <= 0 && name.length() <= 0) {
                if (m == null) {
                    displayExceptionMessage("Menu selected invalid!");
                } else if (mi == null) {
                    displayExceptionMessage("Menu item selected invalid!");
                } else {
