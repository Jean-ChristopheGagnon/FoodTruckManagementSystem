...
foreach ($equipementTypes as $id => $type) {
...
<html>
<head>
    <title>Create an equipment - Food Truck Management System</title>
    <?php include '../include/header.php';?>
</head>
<body><div class="container"><div class="col-xs-12">
    <h1>Create an equipment - Food Truck Management System</h1>
    <?php
    echo $form->form_open('','', "create_submit.php?parentId=".$parentId);
    echo $form->input_text('quantity', 'Quantity:', 1);
    echo $form->input_text('date', 'Purchase Date:', date('Y-m-d'), '', '', 'Format: YYYY-MM-DD');
